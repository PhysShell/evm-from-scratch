...
|---|---|---|---|
| E1 | [Boundary blind-spot corpus](./E1-boundary-blind-spots.md) · [Step 0 preregistration](./E1-step0-preregistration.md) · [Step 2 semantics & plan](./E1-step2-semantics-and-plan.md) | Test whether locally strong test/mutation evidence misses cross-component semantic defects | Independent |
